...
|---|---|---|
| Pull request description | `commands/hve-core/pull-request.md` | `instructions/hve-core/pull-request.instructions.md`, `skills/pr-reference/SKILL.md` |
...
| Standards-focused review | No dedicated command in the current bundle | `agents/coding-standards/code-review-standards.md`, `docs/templates/standards-review-output-format.md` |
